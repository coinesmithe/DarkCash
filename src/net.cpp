...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "DarkCash " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    	{"96.47.239.156", "96.47.239.156"},
		{"96.47.236.105", "96.47.236.105"},
		{"96.47.239.160", "96.47.239.160"},
		{"185.10.58.199", "185.10.58.199"},
		{"96.47.230.40", "96.47.230.40"},
		{"96.47.231.216", "96.47.231.216"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. DarkCash is probably already running."), addrBind.ToString().c_str());
        else
