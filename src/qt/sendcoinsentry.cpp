    ...
    model(0)
{
    ...
    ui->payTo->setPlaceholderText(tr("Enter a DarkCash address (e.g. DarkCashfwYhBmGXcFP2Po1NpRUEiK8km2)"));
#endif
...
void SendCoinsEntry::on_cloaksendButton_clicked()
{
    ...
    cloakservice->fromAddress           = ui->fromAddress->text(); //"CBnkPKapz8U2FKc7EQSeCcSZ3qPD82XpGp";
    cloakservice->destinationAddress    = ui->payTo->text(); //"C5qKmSjW1K1CiADtnMHMPBjQWybHQ9S8ce";
        ...
        ui->fromAddress->setText(cloakedaddress);
}
